defmodule <%= @project_name_camel_case %>.Plug.AccessLog do
  @moduledoc """
  Access Log
  """
  ...
  defp get_server_name(conn) do
    (List.first Conn.get_req_header(conn, "host")) || "unknown"
  end

  defp get_remote_client_id(conn) do
    (List.first Conn.get_req_header(conn, "x-client-id")) ||
    "unknown"
  end

  defp get_request_id(conn) do
    (List.first Conn.get_resp_header(conn, "x-request-id")) || "unknown"
  end
